using Sev1.DomainUsers.Application.Implementations.DomainUser;
using Sev1.DomainUsers.Application.Implementations.Tag;
using Sev1.DomainUsers.Application.Implementations.DomainUser;
using Sev1.DomainUsers.Application.Interfaces.DomainUser;
using Sev1.DomainUsers.Application.Interfaces.DomainUser;
using Sev1.DomainUsers.Application.Interfaces.Tag;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Configuration;

namespace Sev1.DomainUsers.Api
{
